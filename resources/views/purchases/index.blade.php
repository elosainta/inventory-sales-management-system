...
<div class="app-filters" style="display:flex; gap:8px; align-items:center; margin-bottom:24px; flex-wrap:wrap;">
    <a href="{{ route('purchases.index', ['range' => 'today']) }}"
    ...
    <a href="{{ route('purchases.index', ['range' => 'week']) }}"
    ...
    <a href="{{ route('purchases.index', ['range' => 'month']) }}"
    ...
    <a href="{{ route('purchases.index', ['range' => 'year']) }}"
    ...
    <form method="GET" action="{{ route('purchases.index') }}" style="display:flex; gap:6px; align-items:center;">
